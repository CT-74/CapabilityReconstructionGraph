"""
PURPOSE:
Generates the ECS vs CRG Break-Even Curve based on entity size and mutation rate.
Saves the output to the central project 'img/' folder.
"""
import os
import numpy as np
...
def generate_breakeven_plot():
    ...
    # R = Mutation Rate threshold calculation
    ...
    # Highlight the standard cache line threshold
    ...
    out_path = os.path.join(IMG_DIR, "breakeven_curve.png")
